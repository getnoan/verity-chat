 ...
 *
 * The generated files here (INSTALL.md, ci.yml, schema.sql, the seed) are rewritten
...
const CANONICAL_REPO = "getnoan/verity-chat";
...
console.error("     scripts/export-chat.mjs upstream, then re-open this PR.");
process.exit(1);
